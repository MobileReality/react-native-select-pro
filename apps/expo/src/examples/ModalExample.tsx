...
export const ModalExample = () => {
    ...
    return (
        ...
        >
                    ...
                    <View style={styles.centeredView}>
                        <View style={styles.modalView}>
                            <Pressable
                                style={[styles.button, styles.buttonClose]}
                                onPress={() =>
                                    setPageSheetModal(!pageSheetModal)
                                }
                            >
                                <Text style={styles.textStyle}>Hide Modal</Text>
                            </Pressable>
                    ...
                    <View style={styles.centeredView}>
                        <View style={styles.modalView}>
                            <Pressable
                                style={[styles.button, styles.buttonClose]}
                                onPress={() =>
                                    setRNModalSimpleModal(!rnModalSimpleModal)
                                }
                            >
                                <Text style={styles.textStyle}>Hide Modal</Text>
                            </Pressable>
                    ...
                    <View style={styles.centeredView}>
                        <View style={styles.modalView}>
                            <Pressable
                                style={[styles.button, styles.buttonClose]}
                                onPress={() =>
                                    setRNModalPageSheetModal(
                                        !rnModalPageSheetModal,
                                    )
                                }
                            >
                                <Text style={styles.textStyle}>Hide Modal</Text>
            ...
            >
                <Text style={styles.textStyle}>
                    Show Modal with presentationStyle=pageSheet from
                    react-native
                </Text>
            </Pressable>
            ...
            >
                <Text style={styles.textStyle}>
                    Show Modal from react-native-modal
                </Text>
            </Pressable>
