...
| Name       | Type             | Description                                          | Example |
| ---------- | ---------------- | ---------------------------------------------------- | ------- |
| `open`     | `() => void`     | Called when section is removed with section header.  | To Do   |
| `clear`    | `() => void`     | Called when section is selected with section header. | To Do   |
| `close`    | `() => void`     | Called when option is selected.                      | To Do   |
| `getState` | `() => State<T>` | Called when `Select` is opened.                      | To Do   |
