...
| `defaultOption`            | `OptionType<T>` | `OptionType<T>[] |                                     | An object or an array of objects that represent the default option(s) for a `Select`.                                                                                                                                                                                               | <TableExample expo={<DefaultOption />} />            |
